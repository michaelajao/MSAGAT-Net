...
def evaluate(data_loader, data, tag='val', show=0):
    ...
    return float(total_loss / n_samples), mae, std_mae, rmse, rmse_states, pcc, pcc_states, mape, r2, r2_states, var, var_states, peak_mae, y_true_states, y_pred_states
...
for epoch in range(1, args.epochs + 1):
    ...
    val_loss, mae, std_mae, rmse, rmse_states, pcc, pcc_states, mape, r2, r2_states, var, var_states, peak_mae, _, _ = evaluate(data_loader, data_loader.val)
    ...
    if val_loss < best_val:
        ...
        test_loss, test_mae, test_std_mae, test_rmse, test_rmse_states, test_pcc, test_pcc_states, test_mape, test_r2, test_r2_states, test_var, test_var_states, test_peak_mae, _, _ = evaluate(data_loader, data_loader.test)
        print('TEST MAE {:5.4f} std {:5.4f} RMSE {:5.4f} RMSEs {:5.4f} PCC {:5.4f} PCCs {:5.4f} MAPE {:5.4f} R2 {:5.4f} R2s {:5.4f} Var {:5.4f} Vars {:5.4f} Peak {:5.4f}'.format(
            test_mae, test_std_mae, test_rmse, test_rmse_states, test_pcc, test_pcc_states, test_mape, test_r2, test_r2_states, test_var, test_var_states, test_peak_mae))
    else:
        bad_counter += 1
...
test_loss, mae, std_mae, rmse, rmse_states, pcc, pcc_states, mape, r2, r2_states, var, var_states, peak_mae, y_true_final, y_pred_final = evaluate(data_loader, data_loader.test, tag='test')
...
if args.record != '':
    with open("result/result.txt", "a", encoding="utf-8") as f:
        ...
        f.write(f"{args.dataset} {args.window} {args.horizon} {args.train} {args.val} {args.test} "
