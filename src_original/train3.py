...
# Use absolute import for the correct model and utils
from src_original.utils import *  # Keep this as requested
from src_original.data import DataBasicLoader # Import DataBasicLoader explicitly
from src_original.model import MSAGATNet # Import the available model
...
model = MSAGATNet(args, data_loader) # Use MSAGATNet
